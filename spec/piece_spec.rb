...
describe Piece do
  ...
  describe "#generate_horizontal_moves" do
    it "generates an array of moves up to n spaces to the left and right that stay on the board" do
      board = object_double(Board.new, :at => Square.new(WHITE_SQUARE)) #every spot on board is empty
    ...
    it "does not return spaces if blocked by a piece of the same color" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('white', [3,0], nil))) #each spot on the board is always going to say its occupied by a white pawn
      piece = Queen.new('white', [4,0], board) 
    ...
    it "returns a space if occupied by a piece of opposite color, but not spaces past that space" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('black', [3,0], nil))) #each spot on the board is always going to say its occupied by a black pawn
      piece = Queen.new('white', [4,0], board) 
  ...
  describe "#generate_vertical_moves" do
    ...
    it "does not return spaces if blocked by a piece of the same color" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('white', [0,3], nil))) #each spot on the board is always going to say its occupied by a white pawn
      piece = Queen.new('white', [0,4], board) 
      expect(piece.generate_vertical_moves(8)).to eq([])
    end

    it "returns a space if occupied by a piece of opposite color, but not spaces past that space" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('black', [0,3], nil))) #each spot on the board is always going to say its occupied by a black pawn
      piece = Queen.new('white', [0,4], board) 
  ...
  describe "#generate_diagonal_moves" do
    ...
    it "does not return spaces if blocked by a piece of the same color" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('white', [3,3], nil))) #each spot on the board is always going to say its occupied by a white pawn
      piece = Queen.new('white', [4,4], board) 
      expect(piece.generate_diagonal_moves(8)).to eq([])
    end

    it "returns a space if occupied by a piece of opposite color, but not spaces past that space" do
      board = object_double(Board.new, :at => Square.new(Pawn.new('black', [3,3], nil))) #each spot on the board is always going to say its occupied by a black pawn
      piece = Queen.new('white', [4,4], board) 
